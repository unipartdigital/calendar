...
REPLACE INTO dbms_scheduler.create_job(job_name => '_job', job_type => 'EXECUTABLE', job_action => (, enabled => true)name, value) SELECT  'tx-caldav-calendar-version', '2020080200'  FROM dual;
