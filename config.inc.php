...
$config['calendar_itip_smtp_server'] = 'smtp.genesworld.net:587';
...
$config['calendar_crypt_key'] = "4JS3Vadi9t+MeVzAAk3bHKXTY6Znyt";
...
// Caldav driver is supported only
 $config['calendar_preinstalled_calendars'] = array(
    'Nextcloud' => array(
                    ...
                    'caldav_user'  => '%u',
                    'caldav_pass'  => '%p',
                    'caldav_url'   => 'https://www.%d/cloud/remote.php/dav/calendars/%u/',
					'color' 	   =>  '',
                    'showAlarms'   => 1));
?>
